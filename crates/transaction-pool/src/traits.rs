...
pub trait TransactionPool: Clone + Debug + Send + Sync {
    ...
    ///
    /// This is useful for external ordering systems (e.g., score-based reordering) that need to
    /// check whether a transaction can be directly included in a block without violating nonce
